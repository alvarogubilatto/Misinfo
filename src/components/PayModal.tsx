                    ...
                    >
                        <div className="premium-modal-header">
                            <div className="premium-icon-box">
                                <Icon name={pendingPay.icon as any} />
                            </div>
                        ...
                        <div className="premium-amount-section">
                            ...
                            <div className="premium-amount-val">
                                <span>$</span>
                                {pendingPay.amount.toLocaleString('es-MX', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}
                            </div>
                        </div>
                        ...
                        <div className="premium-details-card">
                            ...
                            <div className="premium-detail-row">
                                ...
                                <span className="value">{new Date().toLocaleDateString('es-AR', { day: 'numeric', month: 'short', year: 'numeric' })}</span>
                            </div>
