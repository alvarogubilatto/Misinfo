...
export default function ProfileSectionInfo({ state, setState, showToast, showSuccess, onSave, onLogoutRequest }) {
    ...
    return (
        <div className="panel-section-enter">
            ...
            <div className="form-group">
                ...
                <input className="form-input" type="email" defaultValue="admin@misinfo.com" placeholder="tu@email.com" />
            </div>
            <div className="form-group">
            ...
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', background: 'var(--bg)', borderRadius: 16, padding: '14px 16px', border: '1px solid var(--border)' }}>
                ...
                <div
                    ...
                    style={{ width: 44, height: 24, borderRadius: 99, background: state.darkMode ? colors.primary : 'var(--border)', position: 'relative', cursor: 'pointer', transition: 'background 0.2s', flexShrink: 0 }}
                >
