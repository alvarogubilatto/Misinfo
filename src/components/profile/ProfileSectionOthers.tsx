...
interface ProfileSectionOthersProps {
    activeSection: string;
    showSuccess: (text: string, sub?: string) => void;
}

export default function ProfileSectionOthers({ activeSection, showSuccess }: ProfileSectionOthersProps) {
        ...
        return (
            <div className="panel-section-enter" style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
                <div style={{ background: 'var(--bg)', border: '1px solid var(--border)', borderRadius: 16, padding: '16px', fontSize: 13, color: 'var(--text-muted)', maxHeight: '300px', overflowY: 'auto', lineHeight: 1.5 }}>
                    ...
                    <p style={{ marginBottom: 12 }}>Al usar VOXU, aceptas los términos de uso. VOXU es una aplicación de gestión financiera personal que te permite organizar tus finanzas en Argentina.</p>
                    ...
                    <p>La sincronización bancaria requiere el uso de proveedores regulados. VOXU nunca almacena tus contraseñas directamente.</p>
                </div>
            </div>
        )
    }
