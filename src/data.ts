...
export const defaultState: AppState = {
    ...
    userName: 'Alex',
    subs: [
        { id: 1, icon: 'netflix', color: 'var(--cat-bg-red)', name: 'Netflix Premium', day: 15, price: 299, shared: true, paused: false },
        { id: 2, icon: 'spotify', color: 'var(--cat-bg-green)', name: 'Spotify Duo', day: 20, price: 179, paused: false },
        { id: 3, icon: 'amazon', color: 'var(--cat-bg-blue)', name: 'Amazon Prime', day: 28, price: 99, paused: false },
        { id: 4, icon: 'adobe', color: 'var(--cat-bg-purple)', name: 'Adobe CC', day: 1, price: 699, warning: 'Sube a $749 próx. mes', paused: false },
        { id: 5, icon: 'icloud', color: 'var(--cat-bg-cyan)', name: 'iCloud 200GB', day: 5, price: 39, paused: false },
        { id: 6, icon: 'xbox', color: 'var(--cat-bg-yellow)', name: 'Xbox Game Pass', day: 12, price: 145, paused: false },
    ],
    activities: [
        { id: 1, icon: 'compras', bg: 'var(--text)', name: 'Apple Store', meta: 'Compras · Hoy, 2:45 PM', amount: -120, cat: 'compras' },
        { id: 2, icon: 'gasto', bg: 'var(--cat-bg-green)', name: 'Starbucks', meta: 'Alimentos · Hoy, 9:30 AM', amount: -5.40, cat: 'gasto' },
        { id: 3, icon: 'servicios', bg: 'var(--cat-bg-orange)', name: 'Factura de Luz', meta: 'Servicios · Ayer', amount: -145, cat: 'servicios' },
        { id: 4, icon: 'ingreso', bg: 'var(--cat-green)', name: 'Depósito Sueldo', meta: 'Ingreso · Ayer', amount: 18500, cat: 'ingreso' },
        { id: 5, icon: 'servicios', bg: 'var(--primary)', name: 'Plan Celular', meta: 'Servicios · Hace 2 días', amount: -40, cat: 'servicios' },
    ],
    accounts: [
        { id: 1, icon: 'bank', color: 'var(--cat-bg-blue)', name: 'Banco Galicia', num: '**** 4321', balance: 28400 },
        { id: 2, icon: 'card', color: 'var(--cat-bg-purple)', name: 'Banco Nación', num: '**** 8890', balance: 10200 },
        { id: 3, icon: 'wallet', color: 'var(--cat-bg-green)', name: 'Efectivo', num: 'Billetera', balance: 4250 },
    ],
    properties: [
